...
def call_event(money, customer_list, tmp_customer, customer_queue, server_list, curr_time, total_server, record, day, dining, finish):
    ...
    return money, customer_list, tmp_customer, customer_queue, server_list, record, dining, finish
...
N = 100
T_size = 12
T_detail = [4,4,4,4,4,4,4,4,4,4,4,4]
p = 0.8
k = 2
money = 0
customer_list = []
...
while seed_number <= D:
    ...
    while curr_time < termination_time or len(customer_queue) > 0:
        ...
        # you need to update the argument list
        money, customer_list, tmp_customer, customer_queue, server_list, record_result, dining, finish = call_event(money, customer_list, tmp_customer, customer_queue, server_list, curr_time, T_size, record_result, seed_number, dining, finish)
